...
do
	...
	then
        ...
        then
            timeout $TL python FourierSAT.py --timelimit $TL --globalopt 1 --ismaxsat 1 --beta 0 --globalmode square $filepath > $outpath
        else 
...
run benchmarks/MAXSAT_benchmarks/ fouriersat 
